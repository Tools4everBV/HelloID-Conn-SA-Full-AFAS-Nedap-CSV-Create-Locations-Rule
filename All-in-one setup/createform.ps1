...
'@; 
	...
	$tmpVariables = @'
[{"name":"afasLocationId","value":"{{form.afasLocations.Id}}","secret":false,"typeConstraint":"string"},{"name":"nedapLocationIds","value":"{{form.multiselect.toJsonString}}","secret":false,"typeConstraint":"string"}]
'@ 

	$delegatedFormTaskGuid = [PSCustomObject]@{} 
$delegatedFormTaskName = @'
Nedap-ons-add-locations-rule
'@
